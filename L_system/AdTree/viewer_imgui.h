...
namespace easy3d {
	...
	protected:
        ...
        virtual bool export_lsystem(bool deg, bool gen, bool grow, int sprout_pos, std::vector<float> species_info, int steps_to_average) const = 0;
        virtual bool export_city_json() const = 0;
